...
public class EventListener implements WebDriverListener {
    ...
    public void beforeAnyCall(Object target, Method method, Object[] args) {
        ...
        logger.info("Before calling method: {}", method.getName());
    }

    @Override
    public void afterAnyCall(Object target, Method method, Object[] args, Object result) {
        logger.info("After calling method: {}", method.getName());
    }

    @Override
    public void onError(Object target, Method method, Object[] args, InvocationTargetException e) {
        logger.error("Error while calling method: {}", method.getName() + "-" + e.getMessage());
    }
